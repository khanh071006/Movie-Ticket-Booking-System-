        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, 
                                ...
                                "/api/v1/rooms/**", 
                                "/api/v1/showtimes/**", 
                                "/api/v1/bookings/showtime/*/booked-seats", 
                                "/api/v1/directors/**", 
                                "/api/v1/genres/**", 
                                "/api/v1/movie-statuses/**", 
                                "/api/v1/cast-members/**", 
                                "/api/v1/cinemas/**", 
                                "/api/v1/seat-types/**", 
                                "/api/v1/ticket-types/**", 
                        ...
                        // All other endpoints require authentication, permissions checked via @PreAuthorize in Controllers
